<template>
  ...
  <el-form :model="applyForm" :inline="true" :rules="rules" ref="applyForm" label-width="200px" class="applyForm">
    ...
    <el-form-item label="授权软件名称" prop="softwwarename">
      <el-input v-model="applyForm.softwwarename" style="width: 100%;" placeholder="授权软件名称"></el-input>
    </el-form-item>
    ...
    <el-form-item label="授权到期时间" required>
      <el-col :span="11">
        <el-form-item prop="grantenddate">
          <el-date-picker type="date" placeholder="选择授权到期时间" v-model="applyForm.grantenddate" style="width: 200%;">
          </el-date-picker>
        </el-form-item>
      </el-col>
    </el-form-item>
