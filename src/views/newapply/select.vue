<template>
  ...
  border-top:none;padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:11.0pt;font-family:宋体;color:black'>项目名称<span
                                                lang=EN-US>/</span>标识</span></p>
                                </td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:11.0pt;font-family:宋体;color:black'>{{dialogData.project}}</span>
                                    </p>
                                </td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:11.0pt;font-family:宋体;color:black'>{{dialogData.applyername}}</span>
                                    </p>
                                </td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:11.0pt;font-family:宋体;color:black'>{{dialogData.softwarename}}</span>
                                    </p>
                                </td>
                                <td width=123 nowrap style='width:92.15pt;border-top:none;border-left:none;
  border-bottom:solid #305496 1.0pt;border-right:solid #305496 1.0pt;
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:11.0pt;font-family:宋体;color:black'>{{dialogData.applydate}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.applyername}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.applyertel}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.grantuser}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.grantuserperson}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.grantuserpersontel}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.grantbegindate}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.grantenddate}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.servertype}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.serveros}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.serverip}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.deploymenttype}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.granttype}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:left'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.machinenum}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.productversion}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.grantfiletype}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.usernum}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.controlnum}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.computenum}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.shopinstancenum}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.shopappnum}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.desktopinstancenum}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:20.1pt'>
                                    <p class=MsoNormal align=center style='text-align:center'><span
                                            style='font-size:12.0pt;font-family:宋体;color:black'>{{dialogData.desktopcon}}</span>
                                    </p>
                                </td>
                                <td style='height:20.1pt;border:none' width=0 height=27></td>
                            </tr>
